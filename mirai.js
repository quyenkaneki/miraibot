...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/be-bok/gbanmirai/main/listgban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/be-bok/gbanmirai/main/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/be-bok/gbanmirai/main/data.json').then(json => {
...
💟=======================================💟
\n`, '[ CDAT ]');
        logger("Cảm ơn ae đã sài file bot của CHung Đạt", '[ CDAT ]');
        global.handleListen = loginApiData.listenMqtt(listenerCallback);
        try {
