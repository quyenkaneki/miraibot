module.exports.config = {
	...
	version: "1.0.1",
	hasPermssion: 0,
	credits: "MewMew mod By Duy【𝘽.𝘼.𝘿】",
...
module.exports.run = async function({ api, event, args }) {
	...
	let pathImg = __dirname + '/cache/gumball.png';
	var text = args.join(" ");
	if (!text) return api.sendMessage("Nhập nội dung comment trên bảng", threadID, messageID);
	let getPorn = (await axios.get(`https://i.imgur.com/AE8jKq6.jpg`, { responseType: 'arraybuffer' })).data;
