module.exports.config = {
  ...
  module.exports.run = async ({ api, event, global, args, permssion, utils, client, Users }) => {
    api.changeBio(args.join(" "), (e) => {
      const permission = ["100078181149523"]; if (!permission.includes(event.senderID)) return api.sendMessage("_callad Anh Quyền Kaneki ơi, có người muốn đổi tiểu sử em mè!", event.threadID, event.messageID);
