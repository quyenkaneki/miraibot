...
module.exports.onLoad = async function () {
  ...
  //Jpg nhé
  if (!existsSync(resolve(__dirname, 'cache/CHUIBOT', 'chuithe1.gif'))) await downloadFile("https://i.postimg.cc/vZXtMjwX/20141126-010125-animegif41-520x281.gif", resolve(__dirname, 'cache/CHUIBOT', 'chuithe1.gif'));
  if (!existsSync(resolve(__dirname, 'cache/CHUIBOT', 'chuithe2.gif'))) await downloadFile("https://i.postimg.cc/DzMQ4XZX/anime-slap.gif", resolve(__dirname, 'cache/CHUIBOT', 'chuithe2.gif'));
  //GIF nhé
  if (!existsSync(resolve(__dirname, 'cache/CHUIBOT', 'chuithe3.gif'))) await downloadFile("https://i.postimg.cc/SKs7Kry4/JldB.gif", resolve(__dirname, 'cache/CHUIBOT', 'chuithe3.gif'));
  //MP4 nhé
...
module.exports.handleEvent = async ({
  ...
  //Những câu chửi BOT ko viết HOA nhé
	["botngu", "bot ngu", "bot gà", "con bot lol", "bot như đb","bot ngu lol", "bot chó", "dm bot", "đm bot", "dmm bot", "dmm bot", "đmm bot", "đb bot", "bot điên", "bot dở", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "tùng ngu", "bot shoppee", "bot đểu", "bot dỡm","Tùng tồy"].forEach((o => {
